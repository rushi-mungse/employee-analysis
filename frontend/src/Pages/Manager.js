      ...
      <div className=" mx-auto flex flex-wrap">
        <div className="flex flex-wrap w-full">
            ...
            <div className="flex flex-col">
              <div className="flex relative pb-12">
                ...
                <div className="flex-grow pl-4">
                  ...
                  >
                    <button onClick={() => setLink("Manager")}>Manager</button>
                  </h2>
                </div>
              </div>
              <div className="flex relative pb-12">
                ...
                <div className="flex-grow pl-4">
                  ...
                  >
                    <button onClick={() => setLink("Employee")}>
                      Employee
                    </button>
                  </h2>
                </div>
              ...
              <div className="flex relative pb-12">
                ...
                <div className="flex-grow pl-4">
                  ...
                  >
                    <button onClick={() => setLink("ViewForm")}>
                      View Form
                    </button>
                  </h2>
                </div>
          ...
          <div className="flex items-center justify-center ml-72 flex-col">
            {link === "Manager" && <h1>Manager</h1>}
            {link === "Employee" && <h1>Employee</h1>}
            {link === "ViewForm" && <h1>ViewForm</h1>}
          </div>
        </div>
      </div>
    </section>
